...
namespace Blackbird\EnvironmentBanner\Helper;

use Magento\Framework\App\Helper\Context;
use Blackbird\EnvironmentBanner\Model\Colours;
use Blackbird\EnvironmentBanner\Helper\Blackbird_EnvironmentBanner_Model_Colours;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
     ...
     *
     * @return Blackbird_EnvironmentBanner_Model_Colours|null Null if cannot find colours for current environment
     */
    public function getEnvColours()
    {
        ...
        if ($this->_colours === null) {
            ...
            //$this->_colours = Mage::getModel('Blackbird_EnvironmentBanner/colours')
              //  ->setData($data);
